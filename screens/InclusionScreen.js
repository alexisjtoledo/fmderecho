...
export default function InclusionScreen({ navigation }) {
    ...
    useEffect (() => {
        // Solicitud a la API
            fetch('http://m.fmderecho.com/api/getfromtwitter/inclusion.php')
    ...
    return (
        ...
        <View style={GlobalStyles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[styles.headerTitle, {}]}>Inclusión</Text>
