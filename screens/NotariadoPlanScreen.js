...
export default function NotariadoPlanScreen({ navigation }) {
    ...
    return (
        ...
        <View style={GlobalStyles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[styles.headerTitle, {}]}>Notariado</Text>
            ...
            <View style={styles.contentBox}>
                ...
                <Text style={styles.secondaryText}>del Notariado en esta sección.</Text>
            </View>
        </View>
    )
}
